...
public interface UserFollowMapper {
    ...
    boolean insertFollowUser(@Param("following_id") String following_id, @Param("follower_id") String follower_id);

    @Delete("delete from user_follow " +
            "where u_following_id = #{following_id} and u_follower_id = #{follower_id}")
    boolean deleteFollowUser(@Param("following_id") String following_id, @Param("follower_id") String follower_id);
