package com.example.CourseRecommendation.utils.sensi;
...
public class SensitiveFilter implements Serializable {
     ...
     * 默认的单例，使用自带的敏感词库
     */
    public static final SensitiveFilter DEFAULT;

    static {
        try {
            DEFAULT = new SensitiveFilter(
                    new BufferedReader(new FileReader(MyConfig.RESOURCE_PATH + "txt/sensi_words.txt")));
